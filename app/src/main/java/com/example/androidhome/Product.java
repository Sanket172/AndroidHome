...
//        generateProductData(productModelList, "all");
        ...
        ProductAdapter productAdapter =new ProductAdapter(productModels,  Product.this);
...
//        productModelList.add(new ProductModel("Employee 14", 113));
    ...
    @Override
    public void onUserClick(ProductModel productModel) {

        Toast.makeText(this, "Image Clicked for" + productModel.getProductID(), Toast.LENGTH_SHORT).show();
