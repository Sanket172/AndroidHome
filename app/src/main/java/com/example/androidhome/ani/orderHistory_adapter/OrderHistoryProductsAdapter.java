package com.example.androidhome.ani.orderHistory_adapter;
...
import com.example.androidhome.ani.catagory_model.CatagoryModel;
...
public class OrderHistoryProductsAdapter extends RecyclerView.Adapter<OrderHistoryProductsAdapter.ViewHolderOrderHistory>{
    ...
    @NonNull
    @Override
    public ViewHolderOrderHistory onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ViewHolderOrderHistory holder, int position) {
